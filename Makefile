# This Makefile is for the IPC::System::Simple extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/IPC/System/Simple.pm]
#     AUTHOR => q[U-TINYGOD\pjf <pjf@familiehaase.de>]
#     NAME => q[IPC::System::Simple]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/IPC/System/Simple.pm]
...
FULLEXT = IPC\System\Simple
BASEEXT = Simple
PARENT_NAME = IPC::System
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/IPC/System/Simple.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)\IPC\System
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\IPC\System
...
TO_INST_PM = lib/IPC/System/Simple.pm

PM_TO_BLIB = lib/IPC/System/Simple.pm \
...
DISTVNAME = IPC-System-Simple-0.01
...
Simple.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"IPC::System::Simple\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/IPC/System/Simple.pm $(INST_MAN3DIR)\IPC.System.Simple.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name:         IPC-System-Simple" >> META_new.yml
	$(NOECHO) $(ECHO) "version:      0.01" >> META_new.yml
	$(NOECHO) $(ECHO) "version_from: lib/IPC/System/Simple.pm" >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>Call system() commands with a minimum of fuss</ABSTRACT>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>U-TINYGOD\pjf &lt;pjf@familiehaase.de&gt;</AUTHOR>" >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', '$(PM_FILTER)')" \
	  lib/IPC/System/Simple.pm blib\lib\IPC\System\Simple.pm 
